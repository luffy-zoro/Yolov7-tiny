...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/finally-diou/weights/best.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--name', default='kitti', help='save to project/name')
